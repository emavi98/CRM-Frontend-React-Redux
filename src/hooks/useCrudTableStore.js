...
import { onAddNewProduct, onLoadTable, onUpdateProduct } from "../store/storeSlice";

export const useCrudTableStore = () => {


    const { selectedRecord, actualPage } = useSelector ( state => state.storeData );
      ...
      const startSavingProduct  = () => {
          ...
          if ( selectedRecord.id ) {
            dispatch( onUpdateProduct ( selectedRecord ) )
              ...
              dispatch(onAddNewProduct( { ...selectedRecord , id: new Date().getTime() } ) );
          }
