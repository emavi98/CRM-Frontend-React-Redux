...
export const CustomerForm = () => {
  ...
  const { isProductModalOpen, selectedRecord } = useSelector( state => state.storeData );
  ...
  return (
    ...
    <div className="relative z-0 mb-6 w-full group">
        ...
        type="text" name="email"  id="floating_title" value={selectedRecord.email}
    ...
    <div className="relative z-0 mb-6 w-full group">
        <input 
        className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required="" 
        type="text" name="username" id="floating_description" value={selectedRecord.username}
        onChange={ onInputChange }  />
    ...
    <div className="relative z-0 mb-6 w-full group">
        <input 
        className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required="" 
        type="text" name="password" id="floating_description" value={selectedRecord.password}
        onChange={ onInputChange }  />
    ...
    <div className="relative z-0 mb-6 w-full group">
        ...
        type="text" name="phone" id="floating_category"  placeholder=" " required="" value={selectedRecord.phone}
        onChange={ onInputChange } />
